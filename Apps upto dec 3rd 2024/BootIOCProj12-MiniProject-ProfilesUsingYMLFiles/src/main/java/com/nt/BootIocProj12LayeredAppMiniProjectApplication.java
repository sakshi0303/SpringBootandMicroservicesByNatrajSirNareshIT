...
public class BootIocProj12LayeredAppMiniProjectApplication {
	
	
	public static void main(String[] args) {
	   
		//get IOC container
		ApplicationContext ctx=SpringApplication.run(BootIocProj12LayeredAppMiniProjectApplication.class, args);
