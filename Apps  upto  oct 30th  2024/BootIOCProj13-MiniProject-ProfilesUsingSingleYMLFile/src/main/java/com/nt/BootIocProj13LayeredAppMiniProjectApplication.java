...
public class BootIocProj13LayeredAppMiniProjectApplication {
	
	
	public static void main(String[] args) {
	   
		//get IOC container
		//ApplicationContext ctx=SpringApplication.run(BootIocProj13LayeredAppMiniProjectApplication.class, args);
		   SpringApplication  app=new SpringApplication(BootIocProj13LayeredAppMiniProjectApplication.class);
