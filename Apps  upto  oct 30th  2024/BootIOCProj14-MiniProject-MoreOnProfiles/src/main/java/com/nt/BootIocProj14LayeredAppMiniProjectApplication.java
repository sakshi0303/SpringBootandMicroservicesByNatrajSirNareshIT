...
public class BootIocProj14LayeredAppMiniProjectApplication {
	
	
	public static void main(String[] args) {
	   
		//get IOC container
		ApplicationContext ctx=SpringApplication.run(BootIocProj14LayeredAppMiniProjectApplication.class, args);
